...
public class PeliculaListaController {
	...
	public PeliculaLista show(@PathVariable("usuarioId") int listaId, @PathVariable int peliculaId) { 
	...
	public void borraLista(@PathVariable("usuarioId") int listaId, @PathVariable int peliculaId) {
		PeliculaListaId id = new PeliculaListaId(listaId, peliculaId);
	...
	@ResponseStatus (HttpStatus.CREATED)
	public PeliculaLista actualizaLista(@RequestBody PeliculaLista peliculaLista, @PathVariable int listaId, @PathVariable int peliculaId) {
		PeliculaListaId id = new PeliculaListaId(listaId, peliculaId);
